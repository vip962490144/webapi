...
@ddt
class HandleInvest(unittest.TestCase):
    """
    测试用例类
    """
    ...
    @data(*case_list)
    def test_invest(self, data_ceses):
        ...
        if actual_res.json().get("msg") == "加标成功":
            ...
            if check_sql:
                ...
                HandleContext.load_id = mysql_data["Id"]
                # setattr(HandleContext, "load_id")
